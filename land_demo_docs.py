...
DOCUMENT_SPECS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "body": [
            ...
            "STATUS: PENDING — stage: commission evidence; a survey commissioner has been appointed.",
        ],
...
def _scenario_index() -> List[Dict[str, Any]]:
    ...
    rows: List[Dict[str, Any]] = [
        ...
        },
        {
            ...
            "related_court_cases": ["DEMO-LI-COURT-001-C1 (DEMO-CS-2025-0142, PENDING, next hearing 2026-10-19)"],
        },
        {
            ...
            "related_court_cases": ["DEMO-LI-COURT-002-C1 (DEMO-CS-2025-0198, PENDING, next hearing 2026-11-05)"],
        },
        {
            ...
            "related_encumbrances": [],
            "related_court_cases": ["DEMO-LI-COURT-003-C1 (DEMO-CIVIL-2024-0087, STAYED, injunction 2024-12-12)"],
        },
        {
            "scenario_id": "DEMO-LI-COURT-004", "scenario_type": "COURT — case closed/resolved (false-positive check)",
            "parcel": {"survey": "134", "village": S}, "people": ["Sarita", "Bhola"],
            "expected_verdict": "CLEAR",
            "expected_flags": [],
            "expected_result": "The only case on record is DISPOSED (withdrawn with liberty, 2022-08-19); the parcel must NOT raise an active-litigation alert.",
            "documents_to_upload": ["DEMO-LI-COURT-004-disposal-order.pdf"],
            "expected_alert": "No active-litigation alert; detail shows the disposed case for transparency.",
            "related_mutations": [], "related_encumbrances": [],
            "related_court_cases": ["DEMO-LI-COURT-004-C1 (DEMO-CIVIL-2021-0064, DISPOSED)"],
        },
        {
            ...
            "expected_alert": "No active alert; ownership history shows the COURT_DECREE hop; disposed case listed.",
            "related_mutations": ["DEMO-LI-COURT-005-M1 (M/DEMO/2023/0015, COURT_DECREE, COMPLETED)"],
            "related_encumbrances": [],
            "related_court_cases": ["DEMO-LI-COURT-005-C1 (DEMO-CIVIL-2022-0031, DISPOSED, decree 2023-01-27)"],
        },
        {
