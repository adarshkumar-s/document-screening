...
- **Real Map** — Leaflet record map with keyless Esri World Imagery by default, OpenTopoMap/OpenStreetMap fallbacks, native-zoom safeguards, and a fully offline schematic mode;
